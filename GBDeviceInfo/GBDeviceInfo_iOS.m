    ...
    // Actual device
        ...
        NSDictionary *modelManifest = @{
            ...
            @"iPad": @{
                ...
                // Pro 12.9-inch, 2017
                @[@7, @1]: @[@(GBDeviceModeliPadPro12p9Inch2), @"iPad Pro 12.9-inch 2", @(GBDeviceDisplay12p9Inch), @264],
                @[@7, @2]: @[@(GBDeviceModeliPadPro12p9Inch2), @"iPad Pro 12.9-inch 2", @(GBDeviceDisplay12p9Inch), @264],
